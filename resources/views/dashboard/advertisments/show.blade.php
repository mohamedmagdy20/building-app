                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" type="text" name="name" disabled
                            id="example-text-input" value="{{$data->title}}" required>
                    ...
                    <label for="example-text-input" class="col-sm-2 col-form-label">Publich By</label>
                        <input class="form-control" type="text" 
                            id="example-text-input" value="{{$data->user->name }}" disabled>
                    </div>
                    ...
                    <label for="example-tel-input" class="col-sm-2 col-form-label">Area</label>
                        <input class="form-control" type="text" 
                        id="example-text-input" value="{{$data->area->name_en }}" disabled>
                    </div>

                    <div class="col-md-4">
                        <label for="example-tel-input" class="col-sm-2 col-form-label">Price</label>
                            <input class="form-control" type="text" 
                            id="example-text-input" value="{{$data->price }}" disabled>
                    </div>

                    <div class="col-md-4">
                        <label for="example-tel-input" class="col-sm-2 col-form-label">Location</label>
                            <input class="form-control" type="text" 
                            id="example-text-input" value="{{optional($data)->location}}" disabled>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label for="example-tel-input" class="col-sm-2 col-form-label">Links</label>
                            <input class="form-control" type="text" 
                            id="example-text-input" value="{{optional($data)->links}}" disabled>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label for="example-tel-input" class="col-sm-2 col-form-label">Space</label>
                            <input class="form-control" type="text" 
                            id="example-text-input" value="{{optional($data)->space}}" disabled>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label for="example-tel-input" class="col-sm-2 col-form-label">Advertisment Type</label>
                            <input class="form-control" type="text" 
                            id="example-text-input" value="{{optional($data)->ads_type}}" disabled>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="py-2">
                                <a class="my-image-links" data-gall="gallery0{{$item->id}}" href="{{asset('uploads/ads/'.$item->image)}}"><img class="img-fluid " src="{{asset('uploads/ads/'.$item->image)}}"></a>
                            </div>
                        </div>
                    @endforeach
                    </div>
