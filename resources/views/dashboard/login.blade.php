...
@section('content')
    <div class="card-body">
        ...
        <div class="text-center mt-4">
            <div class="mb-3">
                <img src="{{ asset('assets/images/mainlogo.png') }}" height="100" class="logo-dark mx-auto" alt="">
                <img src="{{ asset('assets/images/mainlogo.png') }}" height="100" class="logo-light mx-auto"
                    alt="">
